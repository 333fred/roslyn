...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class Binder
    {
            ...
            BoundExpression left, BoundExpression right, bool leaveUnconvertedIfInterpolatedString)
        {
            ...
            {
                return new BoundBinaryOperator(node, BinaryOperatorKind.StringConcatenation, BoundBinaryOperator.UncommonData.UnconvertedInterpolatedStringAddition, LookupResultKind.Empty, left, right, right.Type);
            }
